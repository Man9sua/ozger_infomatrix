...
-- =====================================================
-- 6) ASSISTANT SESSIONS / MESSAGES / EVENTS
-- =====================================================
...
create index idx_assistant_sessions_last_message_at on public.assistant_sessions(last_message_at desc);
...
create index idx_assistant_messages_created_at on public.assistant_messages(created_at asc);
...
create index idx_assistant_events_user_id on public.assistant_events(user_id);
create index idx_assistant_events_session_id on public.assistant_events(session_id);
create index idx_assistant_events_created_at on public.assistant_events(created_at desc);
